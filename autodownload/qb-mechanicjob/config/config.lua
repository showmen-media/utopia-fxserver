...
Config.Shops = {
    mechanic = {
        ...
        blipSprite = 72,
        blipColor = 0,
        blipCoords = vector3(-2423.99, 3365.32, 32.45),
        duty = vector3(-348.18, -134.55, 39.59), -- TODO: fix
        stash = vector3(-346.02, -130.68, 39.02), -- TODO: fix
        paint = vector3(-324.11, -147.11, 39.10), -- TODO: fix
        vehicles = {
            withdraw = vector3(-369.30, -104.75, 38.38), -- TODO: fix
            spawn = vector4(-369.65, -107.8, 38.65, 70.52), -- TODO: fix
